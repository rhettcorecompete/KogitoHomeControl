 ...
 */
package https_58_47_47www_46drools_46org_47kie_45dmn_47Dinner;
...
@RestController
@RequestMapping("/0020-dinner")
public class __0020_45dinnerResource {
    ...
    public ResponseEntity<?> dmn(@RequestBody(required = false) java.util.Map<String, Object> variables, HttpServletResponse httpResponse) {
        ...
        KogitoDMNResult result = new KogitoDMNResult("https://www.drools.org/kie-dmn/Dinner", "0020-dinner", decisionResult);
        return extractContextIfSucceded(result);
    }

    @GetMapping(produces = MediaType.APPLICATION_XML_VALUE)
    public String dmn() throws java.io.IOException {
        return new String(org.drools.core.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("0020-dinner") + ".dmn_nologic")));
    }
